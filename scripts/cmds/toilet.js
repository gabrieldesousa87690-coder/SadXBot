...
module.exports = {
  ...
  onStart: async function({ api, event, args }) {
    ...
    if (Object.keys(mentions).length > 0) {
      ...
      return api.sendMessage(
        "❌ Marque, responda ou forneça UID para colocar alguém no vaso",
        threadID,
        messageID
      );
    }
    ...
    try {
      ...
      api.sendMessage(
        { attachment: fs.createReadStream(filePath), body: "Aqui está sua imagem no vaso 🐸" },
        threadID,

...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        bn: "Baixar músicas do YouTube",
                        en: "Download songs/audio from YouTube",
                        vi: "Baixar músicas do YouTube"
                },
                category: "música",
                guide: {
                        bn: '   {pn} [nome da música ou link]\n   Exemplo: {pn} stay justin bieber',
                        en: '   {pn} [song name or link]\n   Example: {pn} stay justin bieber',
                        vi: '   {pn} [nome da música ou link]\n   Exemplo: {pn} see you again'
                }
        },
        ...
        langs: {
                bn: {
                        ...
                        noResult: "⭕ | Desculpe, querido, não encontrei nada para \"%1\".",
                        choose: "Lista de músicas:\n\n%1\nResponda com o número da música.",
                        success: "✅ | Download concluído: %1"
                },
                en: {
        ...
        onStart: async function ({ api, args, message, event, commandName, getLang }) {
                ...
                if (!input) return api.sendMessage("• Por favor, forneça um nome de música ou envie um link.", threadID, messageID);

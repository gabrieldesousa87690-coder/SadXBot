...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        vi: "Baixar vídeo, áudio ou ver informações do vídeo no YouTube",
                        en: "Download video, audio or view video information on YouTube"
                },
                category: "mídia",
                guide: {
                        vi: "   {pn} [video|-v] [<nome do vídeo>|<link do vídeo>]: usar para baixar vídeo do youtube."
                                + "\n   {pn} [audio|-a] [<nome do vídeo>|<link do vídeo>]: usar para baixar áudio do youtube"
                                + "\n   {pn} [info|-i] [<nome do vídeo>|<link do vídeo>]: usar para ver informações do vídeo do youtube"
                                + "\n   Exemplo:"
                                + "\n    {pn} -v Mood Lo-Fi"
                                + "\n    {pn} -a Mood Lo-Fi"
                                + "\n    {pn} -i Mood Lo-Fi",
        ...
        langs: {
                vi: {
                        ...
                        choose: "%1Responda a mensagem com um número para escolher ou qualquer conteúdo para cancelar",
                        video: "vídeo",
                        audio: "áudio",
                        downloading: "⬇️ Baixando %1 \"%2\"",
                        noVideo: "⭕ Desculpe, nenhum vídeo válido encontrado",
                        noAudio: "⭕ Desculpe, nenhum áudio válido encontrado",
                        info: "💠 Título: %1\n🏪 Canal: %2\n👨‍👩‍👧‍👦 Inscritos: %3\n⏱ Duração do vídeo: %4\n👀 Visualizações: %5\n👍 Curtidas: %6\n🆙 Data de upload: %7\n🔠 ID: %8\n🔗 Link: %9"
                },
                en: {
